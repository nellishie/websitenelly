...
function getAuthToken(): string {
  ...
  if (!xReplitToken) {
    console.error("Missing Replit authentication tokens. Required environment variables: REPL_IDENTITY or WEB_REPL_RENEWAL");
    throw new Error(
      "Email service is not available. Please ensure the application is running in the Replit environment with proper authentication."
    );
  }
